...
@Composable
fun HomeScreen(navController: NavHostController, viewModel: WeatherViewModel = viewModel()) {
    ...
    Column(
        ...
        LocationSection(location = "New York") {
            navController.navigate(Destination.LOCATION)
        }
        ...
        ForecastBox {
            navController.navigate(Destination.HOURLY_FORECAST)
        }
    }
}
